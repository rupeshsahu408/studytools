  ...
  if (available.length === 0) {
    return (
      <div className="text-center py-16 max-w-md mx-auto">
        ...
        <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">No Simulations Available</h3>
        <p className="text-sm text-gray-500 dark:text-gray-400">
          No interactive simulations were found for this chapter. Simulations are available for Physics and Chemistry chapters with visualizable concepts.
        </p>
      </div>
    );
  }

  // ── Active Simulation Launcher ──────────────────────────────────────────
  if (activeSim) {
    ...
    <div className="max-w-3xl">
      <div className="flex items-center justify-between mb-5">
        <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
          <Beaker className="w-5 h-5 text-green-600" /> Interactive Simulations
            ...
            <motion.div
              ...
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {sim.topic && (
                    <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5 truncate">{sim.topic}</p>
                  )}
                </div>
              </div>
      ...
      <div className="mt-5 bg-green-50 dark:bg-green-900/10 border border-green-100 dark:border-green-800/30 rounded-xl px-4 py-3 flex items-start gap-2.5">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300">
          Each simulation has real-time parameter controls. Use the <strong>Explain This</strong> button inside any simulation to get an AI explanation of what you're seeing — in Hindi or English.
        </p>
      </div>
    </div>
  );
